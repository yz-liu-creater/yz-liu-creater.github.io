...
const translations = {
  en: {
    ...
    "entry.projects.kicker": "Data Mining Course Project",
    "entry.projects.title": "DataCrunch-2 Stock Return Prediction",
    "entry.projects.copy": "A CrunchDAO DataCrunch-2 project that predicts 28-day U.S. stock returns from anonymized features. It uses gap-aware rolling validation and Extra Trees, ranking 186th with a score of 0.0556.",
    "entry.projects.link": "View repository",
  ...
  zh: {
    ...
    "entry.projects.kicker": "数据挖掘课程大作业",
    "entry.projects.title": "DataCrunch-2 股票收益预测",
    "entry.projects.copy": "基于 CrunchDAO DataCrunch-2 的美股收益预测项目：使用匿名化特征预测未来 28 天收益，通过带隔离期的滚动验证选择 Extra Trees 模型，最终榜单第 186 名，Score 0.0556。",
    "entry.projects.link": "查看 GitHub 仓库",
