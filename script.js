...
const translations = {
  en: {
    ...
    "entry.projects.copy": "A data mining project for weak-signal stock return prediction, covering time-aware validation, model comparison, and an Extra Trees submission.",
  ...
  zh: {
    ...
    "entry.projects.copy": "面向股票收益弱信号预测的数据挖掘项目，涵盖时间感知验证、模型比较与 Extra Trees 线上提交。",
